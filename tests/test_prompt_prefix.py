from repopilot.prompt_prefix import build_prompt_prefix, tool_signature
from repopilot.tools import build_tool_registry
from repopilot.workspace import WorkspaceContext
...
def test_build_prompt_prefix_renders_tools_and_workspace_metadata(tmp_path):
    ...
    assert "You are repopilot" in prefix.text
